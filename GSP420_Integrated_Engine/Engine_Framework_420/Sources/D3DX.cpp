...
BOOL D3DX_Graphics::Initialize( HWND hWnd, BOOL windowed )
{
    Windowed = windowed;
    m_hWnd = hWnd;
    SAFE_RELEASE( m_pD3D9 );
...
//Builds the D3DPRESENT_PARAMETERS structure.
BOOL D3DX_Graphics::BuildPresentParameters()
{
